...
const content = fs.readFileSync('dashboard_head.jsx', 'utf8');
...
const modalsStart = newContent.indexOf('{/* ================= MODAL: Yeni');
if (modalsStart === -1) {
...
newContent = newContent.replace('import { getOgrenciler, getSiniflar', 'import { getSiniflar');
