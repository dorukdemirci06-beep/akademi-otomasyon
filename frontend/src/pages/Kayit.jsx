...
const Kayit = () => {
  ...
  const fetchOgrenciler = async () => {
    try {
      ...
      // Her öğrenci için kayıtlı sınıfları getir
      for (let o of list) {
        try {
  ...
  return (
    <div className="space-y-6">
      {/* Header Bar */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-md transition-colors">
        <div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-md p-6 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-200 dark:border-slate-700 pb-3">
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition flex items-center gap-2 border cursor-pointer ${
                activeTab === 'Aktif'
                  ? 'bg-emerald-50 dark:bg-emerald-950/90 border-[#2eb82e] text-[#2eb82e] shadow-sm'
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition flex items-center gap-2 border cursor-pointer ${
                activeTab === 'Pasif'
                  ? 'bg-sky-50 dark:bg-sky-950/90 border-sky-500 text-sky-600 dark:text-sky-400 shadow-sm'
                  : 'bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200'
              }`}
            >
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <select
              ...
              className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-xs text-slate-700 dark:text-slate-200 font-semibold focus:outline-none focus:border-[#2eb82e] w-full sm:w-auto"
            >
        ...
        <div className="flex justify-between items-center gap-4 flex-wrap">
          <div className="relative flex-1 min-w-[260px]">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-[#2eb82e] transition"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-3 py-1.5 bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-bold rounded-xl border border-slate-200 dark:border-slate-700 transition cursor-pointer"
            >
                  ...
                  return (
                    <React.Fragment key={o.id}>
                      ...
                      <tr 
                        ...
                        className={`hover:bg-slate-100 dark:hover:bg-slate-700/50 transition cursor-pointer select-none ${
                          isExpanded ? 'bg-slate-100 dark:bg-slate-700/80 border-l-4 border-l-[#2eb82e]' : ''
                        }`}
                      >
                        {/* ID */}
                        <td className="py-3.5 px-4 whitespace-nowrap">
                          <span className="font-bold text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-900 px-2 py-1 rounded-md text-xs border border-slate-200 dark:border-slate-700">
                            #{o.id}
                          </span>
                        </td>
                          ...
                          {o.siniflar && o.siniflar.length > 0 ? (
                            <div className="flex items-center gap-1.5">
                              {o.siniflar.slice(0, 2).map((s) => (
                                <span key={s.id} className="bg-slate-100 dark:bg-slate-900 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/60 text-xs px-2.5 py-0.5 rounded-lg font-bold flex items-center gap-1">
                              ...
                              {o.siniflar.length > 2 && (
                                <span className="text-[11px] font-bold bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 px-1.5 py-0.5 rounded-md">
                        ...
                        <td className="py-3.5 px-4 text-right whitespace-nowrap">
                          <div className="flex items-center justify-end gap-2" onClick={(e) => e.stopPropagation()}>
                            <button
                              ...
                              className="px-2.5 py-1.5 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-xs font-semibold rounded-lg transition inline-flex items-center gap-1 border border-slate-200 dark:border-slate-600 cursor-pointer"
                            >
                      ...
                      <tr className={`bg-slate-50/80 dark:bg-slate-900/90 transition-all duration-500 ${isExpanded ? 'border-b border-slate-200 dark:border-slate-700' : '!border-transparent !border-t-0'}`}>
                            ...
                            <div className="overflow-hidden">
                              <div className="p-5 grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
                                ...
                                <div className="space-y-2">
                                  <div className="font-bold text-[#2eb82e] flex items-center gap-1.5 pb-1.5 border-b border-slate-200 dark:border-slate-800">
                                ...
                                <div className="space-y-2">
                                  <div className="font-bold text-[#0284c7] flex items-center gap-1.5 pb-1.5 border-b border-slate-200 dark:border-slate-800">
                                ...
                                <div className="space-y-2">
                                  <div className="font-bold text-[#2eb82e] dark:text-emerald-400 flex items-center gap-1.5 pb-1.5 border-b border-slate-200 dark:border-slate-800">
                                  ...
                                  {o.siniflar && o.siniflar.length > 0 ? (
                                    <div className="space-y-1.5">
                                      {o.siniflar.map((s) => (
                                        <div key={s.id} className="flex justify-between items-center bg-white dark:bg-slate-900 p-2 rounded-lg border border-slate-200 dark:border-slate-800">
            ...
            <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 flex-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="text" name="isim" required value={formData.isim} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="Ahmet" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Soyadı *</label>
                  <input type="text" name="soyisim" required value={formData.soyisim} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="Yılmaz" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="text" name="telefon" value={formData.telefon} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="05551112233" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">E-Posta</label>
                  <input type="text" name="eposta" value={formData.eposta} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="ahmet@gmail.com" />
                </div>
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 focus:border-[#2eb82e] outline-none cursor-pointer"
                  >
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea name="adres" rows="2" value={formData.adres} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="Öğrenci açık adresi..."></textarea>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="text" name="anne_isim" value={formData.anne_isim} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="Ayşe Yılmaz" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Anne Mesleği</label>
                  <input type="text" name="anne_meslek" value={formData.anne_meslek} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="Örn: Öğretmen" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Anne TC Kimlik No</label>
                  <input type="text" name="anne_tc" value={formData.anne_tc} onChange={handleInputChange} maxLength="11" className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="11122233355" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Anne Telefon</label>
                  <input type="text" name="anne_telefon" value={formData.anne_telefon} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="05552223344" />
                </div>
                <div className="sm:col-span-2">
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Anne E-Posta</label>
                  <input type="text" name="anne_eposta" value={formData.anne_eposta} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="anne@gmail.com" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="text" name="baba_isim" value={formData.baba_isim} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="Mehmet Yılmaz" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Baba Mesleği</label>
                  <input type="text" name="baba_meslek" value={formData.baba_meslek} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="Örn: Mühendis" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Baba TC Kimlik No</label>
                  <input type="text" name="baba_tc" value={formData.baba_tc} onChange={handleInputChange} maxLength="11" className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="11122233366" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Baba Telefon</label>
                  <input type="text" name="baba_telefon" value={formData.baba_telefon} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="05553334455" />
                </div>
                <div className="sm:col-span-2">
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Baba E-Posta</label>
                  <input type="text" name="baba_eposta" value={formData.baba_eposta} onChange={handleInputChange} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-[#2eb82e] outline-none" placeholder="baba@gmail.com" />
                </div>
              </div>

              <div className="flex justify-end gap-3 border-t border-slate-200 dark:border-slate-700 pt-4">
                <button type="button" onClick={() => setShowModal(false)} className="px-4 py-2 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-800 dark:text-slate-200 font-semibold text-sm rounded-xl cursor-pointer">İptal</button>
                <button type="submit" className="px-5 py-2 bg-[#2eb82e] hover:bg-[#269926] text-white font-bold text-sm rounded-xl shadow-lg shadow-emerald-900/30 cursor-pointer">Kaydet</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-700 space-y-4 text-slate-800 dark:text-slate-100">
            ...
            <form onSubmit={handleEkDersSubmit} className="space-y-3">
              ...
              <div>
                ...
                <input type="number" value={ekDersData.kalan_ders_hakki} onChange={(e) => setEkDersData({ ...ekDersData, kalan_ders_hakki: e.target.value })} className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-slate-100 focus:border-[#2eb82e] outline-none" />
              </div>
              <div className="flex justify-end gap-2 border-t border-slate-200 dark:border-slate-700 pt-3">
                <button type="button" onClick={() => setShowEkDersModal(false)} className="px-3 py-1.5 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold rounded-lg cursor-pointer">İptal</button>
                <button type="submit" className="px-4 py-1.5 bg-[#2eb82e] hover:bg-[#269926] text-white text-xs font-bold rounded-lg shadow-md cursor-pointer">Ders Hakkını Kaydet</button>
              </div>
            </form>
          </div>
        </div>
