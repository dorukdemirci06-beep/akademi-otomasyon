...
import { 
  ClipboardCheck, CheckCircle2, XCircle, AlertCircle, Users, BookOpen, 
  Calendar, Clock, Plus, Trash2, Save, FileText, X, Sparkles, User,
  History, ChevronDown, ChevronUp, Filter, RefreshCw, CalendarPlus, Maximize2, Minimize2
} from 'lucide-react';
import { 
  getSiniflar, getSinifOgrencileri, getDersProgrami, 
...
const RENK_OPTIONS = [
  ...
  { label: 'Zümrüt', value: 'emerald', bg: 'bg-emerald-100/90 border-emerald-300 text-emerald-950 dark:bg-emerald-100 dark:bg-emerald-950/80 dark:border-emerald-700/80 dark:text-emerald-200 shadow-sm' },
...
const Yoklama = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Top Banner */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-white dark:bg-slate-800 p-6 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl transition-colors">
        <div>
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#2eb82e] to-[#0284c7] hover:from-emerald-600 hover:to-sky-600 text-white font-bold text-sm rounded-xl shadow-lg shadow-emerald-950/20 transition transform hover:-translate-y-0.5 cursor-pointer"
        >
      ...
      <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl p-6 space-y-6">
        ...
        <div className="space-y-4 border-b border-slate-200 dark:border-slate-700 pb-5">
          <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3.5 bg-slate-100 dark:bg-slate-900/70 p-4 rounded-2xl border border-slate-200 dark:border-slate-700/80 items-end shadow-inner">
            {/* 1. Tarih Seçici */}
            <div>
              <CustomDatePicker
            ...
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                className="w-full px-3.5 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-sm font-bold text-slate-900 dark:text-slate-100 focus:outline-none focus:border-[#2eb82e] h-[40px] cursor-pointer"
              >
            ...
            <div>
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 h-[40px] bg-[#2eb82e] hover:bg-[#269926] text-white font-black text-xs uppercase tracking-wider rounded-xl shadow-lg shadow-emerald-900/30 transition disabled:opacity-50 cursor-pointer whitespace-nowrap"
              >
            ...
            <div>
              <button
                ...
                disabled={savingAttendance || !selectedSinifId}
                className="w-full flex items-center justify-center gap-2 px-4 h-[40px] bg-rose-600 hover:bg-rose-700 text-white font-black text-xs uppercase tracking-wider rounded-xl shadow-lg shadow-rose-950/30 transition disabled:opacity-50 cursor-pointer whitespace-nowrap"
        ...
        {/* Bildirim Mesajı */}
        {successMessage && (
          <div className="bg-emerald-100 dark:bg-emerald-100 dark:bg-emerald-950/80 border border-emerald-300 dark:border-emerald-500/80 text-emerald-900 dark:text-emerald-200 px-4 py-3 rounded-xl flex items-center justify-between text-sm font-bold shadow-lg animate-fade-in">
                          ...
                          <div className="flex justify-center items-center gap-3">
                            ...
                            <button
                              ...
                              className={`px-4 py-2 rounded-xl font-bold text-xs flex items-center gap-1.5 transition cursor-pointer ${
                                status === 'Geldi'
                                  ? 'bg-[#2eb82e] text-white shadow-md shadow-emerald-900/30 scale-105'
                                  : 'bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 border border-slate-300 dark:border-slate-700 hover:bg-emerald-50 dark:hover:bg-emerald-950/60 hover:text-[#2eb82e]'
                              }`}
                            >
                            ...
                            <button
                              ...
                              className={`px-4 py-2 rounded-xl font-bold text-xs flex items-center gap-1.5 transition cursor-pointer ${
                                status === 'Gelmedi'
                                  ? 'bg-[#0284c7] text-white shadow-md shadow-sky-900/30 scale-105'
                                  : 'bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 border border-slate-300 dark:border-slate-700 hover:bg-sky-50 dark:hover:bg-sky-950/60 hover:text-[#0284c7]'
                              }`}
                            >
                          ...
                          <td colSpan="5" className="py-2.5 px-6">
                            <div className="flex items-center gap-3">
                              ...
                              <input
                                ...
                                className="w-full px-3 py-1.5 bg-white dark:bg-slate-900 border border-sky-300 dark:border-sky-700/60 rounded-lg text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-[#0284c7]"
                              />
                            </div>
                          </td>
                        </tr>
      ...
      <div ref={historySectionRef} className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl p-6 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
            ...
            <div className="relative flex-1 sm:w-48">
              <input
                ...
                className="w-full pl-8 pr-3 py-1.5 bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-xs font-semibold text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-indigo-500"
              />
            ...
            <select
              ...
              className="px-3 py-1.5 bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-xs font-bold text-slate-800 dark:text-slate-100 focus:outline-none focus:border-indigo-500 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-3 py-1.5 bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-bold rounded-xl border border-slate-300 dark:border-slate-700 transition cursor-pointer"
            >
            ...
            <button
              ...
              className="p-2 bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl border border-slate-300 dark:border-slate-700 transition cursor-pointer"
        ...
        <div className="max-h-[650px] overflow-y-auto p-1.5 space-y-3">
          {loadingGecmis ? (
            ...
            <div className="bg-slate-50 dark:bg-slate-50 dark:bg-slate-900/60 rounded-2xl border border-slate-200 dark:border-slate-700/50 p-8 text-center text-slate-400">
            ...
            filteredOturumlar.map((oturum, idx) => {
              ...
              return (
                <div
                  key={oturum.key}
                  className={`rounded-2xl border shadow-md transition overflow-hidden ${
                    isTelafi 
                      ? 'bg-rose-50/50 dark:bg-slate-900/95 border-rose-300 dark:border-rose-800/80' 
                      : 'bg-white dark:bg-slate-900/90 border-slate-200 dark:border-slate-700/80 hover:border-slate-300 dark:hover:border-slate-600'
                  }`}
                >
                  {/* Oturum Kartı Başlığı */}
                  <div
                    onClick={() => toggleOturumExpand(oturum.key)}
                    className="p-3.5 bg-slate-50 dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800/80 cursor-pointer flex flex-wrap justify-between items-center gap-3 select-none transition"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      {isTelafi && (
                        <div onClick={(e) => e.stopPropagation()}>
                          <CustomDatePicker
                            ...
                            prefix="TELAFİ DERSİ: "
                            icon={CalendarPlus}
                            buttonClassName="bg-rose-100 dark:bg-rose-950 text-rose-800 dark:text-rose-300 border border-rose-300 dark:border-rose-700/90 hover:bg-rose-200 dark:hover:bg-rose-900/90 px-3 py-1.5 rounded-xl text-xs font-black uppercase tracking-wider flex items-center justify-between gap-2 shadow-sm transition cursor-pointer min-w-[220px]"
                            align="left"
                          />
                        </div>
                      )}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 text-[11px] font-bold">
                        ...
                        <span className="bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 px-2.5 py-0.5 rounded-full border border-slate-200 dark:border-slate-700">
                  ...
                  <div className={`grid transition-all duration-500 ease-in-out ${isExpanded ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                    <div className="overflow-hidden">
                      <div className="p-4 bg-slate-50/60 dark:bg-slate-900/40 overflow-x-auto border-t border-slate-200 dark:border-slate-800">
                        <table className="w-full text-left text-xs border-collapse">
                          <thead>
                            <tr className="text-slate-500 dark:text-slate-400 font-bold tracking-wider border-b border-slate-200 dark:border-slate-800 pb-2">
                                  ...
                                  <div className="flex items-center justify-center gap-1.5">
                                    <button
                                      ...
                                      className={`px-2.5 py-1 rounded-lg text-[11px] font-black border transition cursor-pointer flex items-center gap-1 ${
                                        item.durum === 'Geldi'
                                          ? 'bg-emerald-100 dark:bg-emerald-950 text-emerald-800 dark:text-[#2eb82e] border-emerald-300 dark:border-emerald-700 shadow-sm'
                                    ...
                                    <button
                                      ...
                                      className={`px-2.5 py-1 rounded-lg text-[11px] font-black border transition cursor-pointer flex items-center gap-1 ${
                                        item.durum === 'Gelmedi'
                                          ? 'bg-rose-100 dark:bg-rose-950 text-rose-800 dark:text-rose-400 border-rose-300 dark:border-rose-700 shadow-sm'
                                          : 'bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 border-slate-300 dark:border-slate-700 hover:text-slate-900 dark:hover:text-white'
                                      }`}
                                    ...
                                    <button
                                      ...
                                      className={`px-2.5 py-1 rounded-lg text-[11px] font-black border transition cursor-pointer flex items-center gap-1 ${
                                        item.durum === 'Mazeretli'
                                          ? 'bg-sky-100 dark:bg-sky-950 text-sky-800 dark:text-sky-400 border-sky-300 dark:border-sky-700 shadow-sm'
                                          : 'bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 border-slate-300 dark:border-slate-700 hover:text-slate-900 dark:hover:text-white'
                                      }`}
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl shadow-2xl w-full max-w-md p-6 space-y-5 animate-scale-in text-slate-800 dark:text-slate-100">
            ...
            <form onSubmit={handleAddDersSubmit} className="space-y-4 text-sm">
              <div>
                ...
                <select
                  ...
                  required
                  className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl font-bold text-slate-900 dark:text-slate-100 focus:outline-none focus:border-indigo-500"
                >
                  <option value="">-- Sınıf Seçin --</option>
                  {siniflar.map(s => (
                    <option key={s.id} value={s.id}>{s.sinif_adi}</option>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewDersForm(prev => ({ ...prev, baslangic_saati: e.target.value }))}
                    required
                    className="w-full px-3.5 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl font-bold text-slate-900 dark:text-slate-100 focus:outline-none focus:border-indigo-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewDersForm(prev => ({ ...prev, bitis_saati: e.target.value }))}
                    required
                    className="w-full px-3.5 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl font-bold text-slate-900 dark:text-slate-100 focus:outline-none focus:border-indigo-500"
                  />
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-indigo-500"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewDersForm(prev => ({ ...prev, ogretmen_adi: e.target.value }))}
                  className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-xs font-bold text-slate-900 dark:text-slate-100 focus:outline-none focus:border-indigo-500"
                >
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-[#0284c7] hover:bg-[#0369a1] text-white text-xs font-bold rounded-xl shadow-md cursor-pointer"
                >
                  Dersi Kaydet
                </button>
              </div>
            ...
            <form onSubmit={handleCreateTelafiSubmit} className="space-y-4 text-sm">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 font-bold focus:outline-none focus:border-rose-500"
                >
                  <option value="">-- Sınıf Seçin --</option>
                  {siniflar.map(s => (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-rose-500"
                />
              </div>
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-rose-600 hover:bg-rose-700 text-white text-xs font-black rounded-xl shadow-lg shadow-rose-950/40 transition cursor-pointer disabled:opacity-50"
                >
