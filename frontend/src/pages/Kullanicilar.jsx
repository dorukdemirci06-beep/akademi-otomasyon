...
const Kullanicilar = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Main Header Banner */}
      <div className="bg-white dark:bg-slate-800 p-6 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-colors">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-[#2eb82e] to-[#0284c7] flex items-center justify-center text-white shadow-lg shadow-emerald-900/20 shrink-0">
        ...
        <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-900 p-1.5 rounded-2xl border border-slate-200 dark:border-slate-700/80 w-full md:w-auto overflow-x-auto">
          <button
            type="button"
            ...
            className={`flex-1 md:flex-none px-3.5 py-2 rounded-xl text-xs font-bold transition flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap ${
              activeTab === 'kullanicilar'
                ? 'bg-[#2eb82e] text-white shadow-md shadow-emerald-900/30'
          ...
          <button
            ...
            className={`flex-1 md:flex-none px-3.5 py-2 rounded-xl text-xs font-bold transition flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap ${
              activeTab === 'ogretmenler'
                ? 'bg-gradient-to-r from-sky-600 to-blue-600 text-white shadow-md shadow-sky-950/30'
                : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-800'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 md:flex-none px-3.5 py-2 rounded-xl text-xs font-bold transition flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap ${
              activeTab === 'personel'
                ? 'bg-gradient-to-r from-indigo-500 to-sky-500 text-white shadow-md shadow-indigo-950/30'
                : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-800'
            }`}
          >
      ...
      {activeTab === 'kullanicilar' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-scale-in">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl p-6 space-y-4 text-slate-800 dark:text-slate-100">
            ...
            <form onSubmit={handleSubmitUser} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full py-3 bg-[#2eb82e] hover:bg-[#269926] text-white font-bold text-sm rounded-xl shadow-lg shadow-emerald-900/30 transition mt-2 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
          ...
          {/* User List Table */}
          <div className="lg:col-span-2 bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl p-6 space-y-4">
            <div className="flex justify-between items-center border-b border-slate-200 dark:border-slate-700 pb-3">
              ...
              <button
                ...
                className="p-2 bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-xl border border-slate-200 dark:border-slate-700 transition cursor-pointer"
                title="Yenile"
              >
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-700/60 text-sm">
                  {loading ? (
                    ...
                    kullanicilar.map((u) => (
                      <tr key={u.id} className="hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors">
      ...
      {activeTab === 'ogretmenler' && (
        <div className="space-y-6 animate-scale-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-white dark:bg-slate-800 border border-sky-200 dark:border-sky-500/30 rounded-3xl p-5 flex items-center gap-4 bg-sky-500/5 shadow-lg">
            ...
            <div className="bg-white dark:bg-slate-800 border border-emerald-200 dark:border-emerald-500/30 rounded-3xl p-5 flex items-center gap-4 bg-emerald-500/5 shadow-lg">
              <div className="w-12 h-12 rounded-2xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center text-[#2eb82e] shrink-0">
            ...
            <div className="bg-white dark:bg-slate-800 border border-indigo-200 dark:border-indigo-500/30 rounded-3xl p-5 flex flex-col justify-between gap-3 shadow-lg">
              ...
              <div className="grid grid-cols-2 gap-2 w-full">
                <button
                  ...
                  className="w-full py-2 px-2 bg-[#2eb82e] hover:bg-[#269926] text-white font-bold text-xs rounded-xl shadow-md transition flex items-center justify-center gap-1 cursor-pointer truncate"
                >
                ...
                <button
                  ...
                  className="w-full py-2 px-2 bg-gradient-to-r from-sky-600 to-blue-600 hover:from-sky-500 hover:to-blue-500 text-white font-bold text-xs rounded-xl shadow-md transition flex items-center justify-center gap-1 cursor-pointer truncate"
                >
          ...
          {/* Sub Navigation Bar */}
          <div className="bg-white dark:bg-slate-800 p-4 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-900 p-1.5 rounded-2xl border border-slate-200 dark:border-slate-700 w-full sm:w-auto">
              <button
                type="button"
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="w-full bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl pl-9 pr-3.5 py-2 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-amber-500"
              />
            </div>
          </div>
          ...
          {(ogretmenSubTab === 'all' || ogretmenSubTab === 'kadro') && (
            <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl p-6 space-y-4">
              <div className="flex justify-between items-center border-b border-slate-200 dark:border-slate-700 pb-4">
                ...
                <button
                  type="button"
                  onClick={openAddTeacherModal}
                  className="flex items-center gap-2 px-4 py-2 bg-[#2eb82e] hover:bg-[#269926] text-white font-bold text-xs rounded-xl shadow-lg transition cursor-pointer"
                >
                  <UserPlus className="w-4 h-4" />
              ...
              {filteredTeachers.length === 0 ? (
                <div className="bg-slate-50 dark:bg-slate-50 dark:bg-slate-900/60 rounded-2xl border border-slate-200 dark:border-slate-700/60 p-10 text-center text-slate-400">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  {filteredTeachers.map((teacher) => {
                    ...
                    return (
                      <div
                        key={teacher.id}
                        className="bg-slate-50 dark:bg-slate-900/90 rounded-2xl border border-slate-200 dark:border-slate-700/80 p-5 shadow-lg flex flex-col justify-between space-y-4 hover:border-amber-500/60 transition group"
                      >
                        <div>
                          {/* Card Header */}
                          <div className="flex justify-between items-start gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
                            <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-1 shrink-0">
                              <button
                                ...
                                className="p-1.5 text-slate-400 hover:text-amber-500 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-lg transition cursor-pointer"
                          ...
                          <div className="space-y-2 mt-3 text-xs text-slate-600 dark:text-slate-300">
                            ...
                            {teacher.notlar && (
                              <p className="text-[11px] text-slate-500 dark:text-slate-400 italic bg-white dark:bg-slate-950/40 p-2 rounded-lg border border-slate-200 dark:border-slate-800/80">
                                {teacher.notlar}
                              </p>
                            )}
                          </div>
          ...
          {(ogretmenSubTab === 'all' || ogretmenSubTab === 'degerlendirmeler') && (
            <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl p-6 space-y-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b border-slate-200 dark:border-slate-700 pb-4">
                ...
                <button
                  type="button"
                  onClick={() => openAddEvalModal('ogretmen')}
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-sky-600 to-blue-600 hover:from-sky-500 hover:to-blue-500 text-white font-bold text-xs rounded-xl shadow-lg transition cursor-pointer"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  {teacherEvals.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="bg-slate-50 dark:bg-slate-900/90 rounded-2xl border border-slate-200 dark:border-slate-700/80 p-5 shadow-lg flex flex-col justify-between space-y-4 hover:border-amber-500/60 transition"
                      >
                        <div>
                          ...
                          {/* Stars Rating */}
                          <div className="flex items-center justify-between mt-3 bg-white dark:bg-slate-950/60 p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                          ...
                          {/* Feedback Notes */}
                          {item.notlar && (
                            <div className="mt-3 text-xs text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-950/40 p-3 rounded-xl border border-slate-200 dark:border-slate-800/60 italic leading-relaxed">
                              "{item.notlar}"
                            </div>
                          )}
                        ...
                        <div className="text-[11px] text-slate-500 pt-2 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
      ...
      {activeTab === 'personel' && (
        <div className="space-y-6 animate-scale-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-white dark:bg-slate-800 border border-indigo-200 dark:border-indigo-500/30 rounded-3xl p-5 flex items-center gap-4 bg-indigo-500/5 shadow-lg">
              <div className="w-12 h-12 rounded-2xl bg-indigo-500/15 border border-indigo-500/30 flex items-center justify-center text-indigo-500 shrink-0">
            ...
            <div className="bg-white dark:bg-slate-800 border border-emerald-200 dark:border-emerald-500/30 rounded-3xl p-5 flex flex-col justify-between gap-3 shadow-lg">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-slate-500 dark:text-slate-400 block">Hızlı İşlemler</span>
              ...
              <div className="grid grid-cols-2 gap-2 w-full">
                ...
                <button
                  ...
                  className="w-full py-2 px-2 bg-gradient-to-r from-indigo-500 to-sky-500 hover:from-indigo-400 hover:to-sky-400 text-white font-bold text-xs rounded-xl shadow-md transition flex items-center justify-center gap-1 cursor-pointer truncate"
                >
                  <Plus className="w-3.5 h-3.5 shrink-0" />
                  <span className="truncate">Değerlendirme</span>
                </button>
          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="w-full bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl pl-9 pr-3.5 py-2 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-sky-500"
              />
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  {filteredStaff.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="bg-slate-50 dark:bg-slate-900/90 rounded-2xl border border-slate-200 dark:border-slate-700/80 p-5 shadow-lg flex flex-col justify-between space-y-4 hover:border-sky-500/60 transition group"
                      >
                        <div>
                          {/* Card Header */}
                          <div className="flex justify-between items-start gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
                            ...
                            <div className="flex items-center gap-1 shrink-0">
                              <button
                                ...
                                className="p-1.5 text-slate-400 hover:text-sky-500 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-lg transition cursor-pointer"
                                title="Bilgileri Düzenle"
                              >
                                <Edit3 className="w-4 h-4" />
                              </button>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl p-6 space-y-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b border-slate-200 dark:border-slate-700 pb-4">
                ...
                <button
                  type="button"
                  onClick={() => openAddEvalModal('personel')}
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-sky-500 hover:from-indigo-400 hover:to-sky-400 text-white font-bold text-xs rounded-xl shadow-lg transition cursor-pointer"
                >
                  <Plus className="w-4 h-4" />
                  <span>Değerlendirme Ekle</span>
                </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  {staffEvals.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="bg-slate-50 dark:bg-slate-900/90 rounded-2xl border border-slate-200 dark:border-slate-700/80 p-5 shadow-lg flex flex-col justify-between space-y-4 hover:border-sky-500/60 transition"
                      >
                        <div>
                          {/* Top Bar: Name & Actions */}
                          <div className="flex justify-between items-start gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
      ...
      {showTeacherModal && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-2xl max-w-md w-full p-6 space-y-5 animate-scale-in text-slate-800 dark:text-slate-100">
            <div className="flex justify-between items-center border-b border-slate-200 dark:border-slate-700 pb-3">
            ...
            <form onSubmit={handleSaveTeacher} className="space-y-4 text-sm">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 focus:outline-none focus:border-amber-500"
                />
              </div>
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-[#2eb82e] hover:bg-[#269926] text-white text-xs font-black rounded-xl shadow-lg transition cursor-pointer"
                >
            ...
            <form onSubmit={handleSaveStaff} className="space-y-4 text-sm">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 focus:outline-none focus:border-sky-500"
                />
              </div>
            ...
            <form onSubmit={handleSaveEval} className="space-y-4 text-sm">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-amber-500"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900 p-3 rounded-xl border border-slate-200 dark:border-slate-700 justify-between">
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-gradient-to-r from-sky-600 to-blue-600 hover:from-sky-500 hover:to-blue-500 text-white text-xs font-black rounded-xl shadow-lg transition cursor-pointer"
                >
