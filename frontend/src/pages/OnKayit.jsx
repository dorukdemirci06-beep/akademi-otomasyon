...
const OnKayit = () => {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {toastMessage && (
        <div
          className={`fixed bottom-6 right-6 z-50 px-5 py-3.5 rounded-2xl shadow-2xl border backdrop-blur-md transition-all duration-300 flex items-center gap-3 text-sm font-semibold ${
      ...
      {/* Header Banner */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-800 p-6 rounded-3xl border border-slate-200 dark:border-slate-700/80 shadow-xl transition-colors">
        <div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-[#2eb82e] to-[#0284c7] flex items-center justify-center text-white shadow-lg shadow-emerald-900/20">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
        <div className="bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/70 rounded-2xl p-4 flex flex-col justify-between shadow-sm">
        ...
        <div className="bg-white dark:bg-slate-800/80 border border-amber-200 dark:border-amber-500/30 rounded-2xl p-4 flex flex-col justify-between bg-amber-50/50 dark:bg-amber-500/5 shadow-sm">
        ...
        <div className="bg-white dark:bg-slate-800/80 border border-sky-200 dark:border-sky-500/30 rounded-2xl p-4 flex flex-col justify-between bg-sky-50/50 dark:bg-sky-500/5 shadow-sm">
        ...
        <div className="bg-white dark:bg-slate-800/80 border border-orange-200 dark:border-orange-500/30 rounded-2xl p-4 flex flex-col justify-between bg-orange-50/50 dark:bg-orange-500/5 shadow-sm">
        ...
        <div className="col-span-2 sm:col-span-1 bg-white dark:bg-slate-800/80 border border-emerald-200 dark:border-emerald-500/30 rounded-2xl p-4 flex flex-col justify-between bg-emerald-50/50 dark:bg-emerald-500/5 shadow-sm">
      ...
      {/* A. ÖN KAYIT FORMU */}
      <div className="bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700/80 rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden text-slate-800 dark:text-slate-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-white dark:bg-slate-900/90 border border-slate-300 dark:border-slate-700/90 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-[#2eb82e] focus:ring-1 focus:ring-[#2eb82e] transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-white dark:bg-slate-900/90 border border-slate-300 dark:border-slate-700/90 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-[#2eb82e] focus:ring-1 focus:ring-[#2eb82e] transition-all"
                />
              </div>
            </div>
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full bg-white dark:bg-slate-900/90 border border-slate-300 dark:border-slate-700/90 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:border-[#2eb82e] focus:ring-1 focus:ring-[#2eb82e] transition-all cursor-pointer"
                  >
                    <option value="">-- Mevcut Sınıflardan Seçiniz --</option>
                    {siniflar.map((s) => (
                      <option key={s.id} value={s.sinif_adi} className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">
                        {s.sinif_adi} (Kapasite: {s.kapasite})
                      </option>
                    ))}
                    <option value="DIGER_MANUEL" className="bg-white dark:bg-slate-900 text-amber-300 font-bold">
                ...
                {isCustomBrans && (
                  <div className="relative animate-scale-in">
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-white dark:bg-slate-900/90 border border-amber-500/60 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-all"
                    />
                  </div>
                )}
              </div>
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-3">
              ...
              <textarea
                ...
                rows="2"
                className="w-full bg-white dark:bg-slate-900/90 border border-slate-300 dark:border-slate-700/90 rounded-xl px-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-[#2eb82e] focus:ring-1 focus:ring-[#2eb82e] transition-all resize-none"
              />
            </div>
          ...
          <div className="flex justify-end pt-2">
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center gap-2 bg-gradient-to-r from-[#2eb82e] to-emerald-600 hover:from-emerald-500 hover:to-emerald-600 text-white px-6 py-2.5 rounded-xl font-bold text-sm shadow-lg shadow-emerald-900/40 hover:shadow-emerald-900/60 transition-all duration-200 disabled:opacity-50"
            >
              <UserPlus className="w-4 h-4" />
      ...
      <div className="bg-slate-800/90 border border-slate-700/80 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-300 dark:border-slate-700/60">
          <div>
            <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
              <span>Ön Kayıt Aday Listesi</span>
              <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-slate-700 text-slate-700 dark:text-slate-300">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative min-w-[220px]">
              ...
              <input
                ...
                className="w-full bg-white dark:bg-slate-900/90 border border-slate-300 dark:border-slate-700 rounded-xl pl-9 pr-3 py-1.5 text-xs text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-[#2eb82e]"
              />
            </div>
            ...
            <select
              ...
              className="bg-white dark:bg-slate-900/90 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-1.5 text-xs font-semibold text-slate-200 focus:outline-none focus:border-[#2eb82e]"
            >
        ...
        <div className="overflow-x-auto">
          {loading ? (
            ...
            <div className="text-center py-12 bg-slate-900/40 rounded-2xl border border-dashed border-slate-700/70 text-slate-400">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-300 dark:border-slate-700 text-[11px] font-bold text-slate-400 tracking-wider bg-slate-900/40">
              ...
              <tbody className="divide-y divide-slate-700/60 text-sm">
                {filteredKayitlar.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors">
                      {/* Öğrenci */}
                      ...
                      <td className="py-3.5 px-4">
                        {item.ilgilenilen_brans ? (
                          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-700/60 border border-slate-600/60 text-xs font-semibold text-slate-200">
                        ...
                        >
                          {DURUM_OPTIONS.map((opt) => (
                            <option
                              key={opt.value}
                              value={opt.value}
                              className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 py-1 font-semibold"
                            >
                              {opt.label}
                            </option>
                          ))}
                      ...
                      <td className="py-3.5 px-4 text-right whitespace-nowrap">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-[#2eb82e] to-emerald-600 hover:from-emerald-500 hover:to-emerald-600 text-white text-xs font-bold shadow-md shadow-emerald-900/30 hover:shadow-emerald-900/50 transition-all duration-200 active:scale-95"
      ...
      {showConvertModal && selectedKayit && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-slate-800 rounded-3xl max-w-2xl w-full max-h-[92vh] overflow-y-auto p-6 sm:p-8 shadow-2xl border border-slate-700/80 space-y-6 relative">
            
            {/* Modal Header */}
            <div className="flex justify-between items-start border-b border-slate-700/70 pb-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-[#2eb82e] to-emerald-600 flex items-center justify-center text-white shadow-lg shadow-emerald-900/40">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-200 p-1 rounded-lg hover:bg-slate-700/60 transition"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleConvertSubmit} className="space-y-5">
              ...
              {/* 1. Öğrenci Bilgileri */}
              <div className="bg-slate-50 dark:bg-slate-900/60 p-4 rounded-2xl border border-slate-300 dark:border-slate-700/60 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:border-[#2eb82e] outline-none"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-600 focus:border-[#2eb82e] outline-none"
                    />
                  </div>
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleConvertInputChange}
                      className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:border-[#2eb82e] outline-none cursor-pointer"
                    >
                      <option value="">-- Mevcut Sınıflardan Seçiniz --</option>
                      {siniflar.map((s) => (
                        <option key={s.id} value={s.sinif_adi} className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">
              ...
              <div className="bg-slate-50 dark:bg-slate-900/60 p-4 rounded-2xl border border-slate-300 dark:border-slate-700/60 space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-slate-300 dark:border-slate-700/60">
                  ...
                  <div className="flex items-center gap-1 bg-slate-800 p-1 rounded-xl border border-slate-300 dark:border-slate-700">
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 ${
                        veliTuru === 'anne'
                          ? 'bg-[#0284c7] text-white shadow-md shadow-sky-950/40'
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:border-[#0284c7] outline-none"
                      />
                    </div>
                    <div>
              ...
              <div className="flex items-center justify-end gap-3 border-t border-slate-700/70 pt-4">
                <button
                  type="button"
                  onClick={() => setShowConvertModal(false)}
                  className="px-4 py-2.5 rounded-xl bg-slate-700 hover:bg-slate-600 text-slate-200 font-semibold text-xs transition"
                >
                  İptal
                </button>
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex items-center gap-2 bg-gradient-to-r from-[#2eb82e] to-emerald-600 hover:from-emerald-500 hover:to-emerald-600 text-white px-6 py-2.5 rounded-xl font-bold text-xs shadow-lg shadow-emerald-900/40 hover:shadow-emerald-900/60 transition disabled:opacity-50"
                >
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl animate-scale-in">
            <div className="sticky top-0 z-10 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700/60 p-6 flex justify-between items-center">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 hover:bg-rose-100 hover:text-rose-600 dark:hover:bg-rose-500/20 dark:hover:text-rose-400 flex items-center justify-center transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <form onSubmit={handleEditSubmit} className="p-6 space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input type="text" name="ogrenci_adi" value={editFormData.ogrenci_adi} onChange={handleEditInputChange} required className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">Öğrenci Soyadı</label>
                  <input type="text" name="ogrenci_soyadi" value={editFormData.ogrenci_soyadi} onChange={handleEditInputChange} required className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">Veli Adı</label>
                  <input type="text" name="veli_adi" value={editFormData.veli_adi || ''} onChange={handleEditInputChange} className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">Veli Soyadı</label>
                  <input type="text" name="veli_soyadi" value={editFormData.veli_soyadi || ''} onChange={handleEditInputChange} className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">İletişim Telefonu</label>
                  <input type="text" name="telefon" value={editFormData.telefon || ''} onChange={handleEditInputChange} className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">İlgilenilen Branş</label>
                  <input type="text" name="ilgilenilen_brans" value={editFormData.ilgilenilen_brans || ''} onChange={handleEditInputChange} className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100" />
                </div>
                <div className="md:col-span-2">
                  <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5">Kayıt Notu</label>
                  <textarea name="notlar" value={editFormData.notlar || ''} onChange={handleEditInputChange} rows="3" className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-900 dark:text-slate-100" />
                </div>
              </div>

              <div className="flex justify-end pt-4 border-t border-slate-200 dark:border-slate-700/60 gap-3">
                <button type="button" onClick={() => setShowEditModal(false)} className="px-5 py-2.5 rounded-xl font-bold text-sm text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors">
                  İptal
                </button>
                <button type="submit" disabled={submitting} className="px-5 py-2.5 rounded-xl font-bold text-sm text-white bg-[#2eb82e] hover:bg-[#259925] disabled:opacity-50 transition-colors">
