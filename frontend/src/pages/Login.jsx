...
const Login = ({ onLoginSuccess }) => {
  ...
  const handleQuickFillAdmin = () => {
    setSelectedAkademi('Test1');
    setKullaniciAdi('doruk');
    setSifre('1111');
    setErrorMsg('');
  };

  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 flex flex-col justify-center items-center p-4 relative overflow-hidden font-sans transition-colors duration-300">
      ...
      <div className="absolute top-4 right-4 z-20">
        <button
          type="button"
          onClick={toggleTheme}
          className={`p-2 rounded-xl border transition-all duration-300 cursor-pointer flex items-center justify-center shadow-md ${
            theme === 'light'
              ? 'bg-white/90 border-amber-300 text-amber-900 hover:bg-amber-100'
      ...
      <div className="max-w-sm w-full space-y-4 z-10">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-tr from-[#2eb82e] to-[#0284c7] text-white shadow-xl shadow-emerald-500/20 mb-0.5">
        ...
        {/* Login Form Card */}
        <div className="bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 sm:p-6 shadow-xl backdrop-blur-xl space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="relative" ref={comboboxRef}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl pl-9 pr-8 py-2.5 text-xs text-slate-900 dark:text-slate-100 font-semibold placeholder-slate-400 focus:outline-none focus:border-[#2eb82e] focus:ring-1 focus:ring-[#2eb82e] transition shadow-xs cursor-pointer"
                />
              ...
              {akademiComboboxOpen && (
                <div className="absolute left-0 right-0 top-full mt-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl z-50 max-h-48 overflow-y-auto p-1 text-xs animate-scale-in">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl pl-9 pr-3.5 py-2.5 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-[#2eb82e] focus:ring-1 focus:ring-[#2eb82e] transition shadow-xs"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-gradient-to-r from-[#2eb82e] to-emerald-600 hover:from-emerald-500 hover:to-emerald-600 text-white font-bold text-xs rounded-xl shadow-md shadow-emerald-500/20 transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 mt-1 cursor-pointer"
            >
          ...
          {/* Preset Quick Fill for Admin & Setup Screen Button */}
          <div className="pt-2 border-t border-slate-200 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-2 gap-2">
            <button
              type="button"
              onClick={handleQuickFillAdmin}
              className="w-full py-2 px-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800/80 dark:hover:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-[11px] font-semibold transition flex items-center justify-center gap-1.5 group cursor-pointer shadow-xs"
            >
            ...
            <button
              ...
              className="w-full py-2 px-2.5 bg-sky-50 hover:bg-sky-100 dark:bg-sky-950/60 dark:hover:bg-sky-900/80 border border-sky-300 dark:border-sky-700/80 text-sky-800 dark:text-sky-200 rounded-xl text-[11px] font-bold transition flex items-center justify-center gap-1.5 group cursor-pointer shadow-xs"
            >
      ...
      {/* ================= MODAL 1: Kurulum Ekranı Yetkili Şifresi Doğrulama (8888) ================= */}
      {showPinModal && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[105] flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-xs w-full p-5 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-4 text-slate-800 dark:text-slate-100 animate-scale-in">
            ...
            <form onSubmit={handlePinSubmit} className="space-y-3">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl pl-9 pr-3 py-2 text-xs font-bold text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500"
                  />
                </div>
              </div>
              ...
              <div className="flex justify-end gap-2 pt-1 border-t border-slate-200 dark:border-slate-800">
                <button
                  type="button"
                  onClick={() => setShowPinModal(false)}
                  className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold rounded-xl transition cursor-pointer"
                >
                  İptal
                </button>
                <button
                  type="submit"
                  className="px-4 py-1.5 bg-amber-500 hover:bg-amber-600 text-white font-bold text-xs rounded-xl shadow-md transition flex items-center gap-1 cursor-pointer"
                >
                  <span>Giriş Yap</span>
                </button>
              </div>
      ...
      {showKurulumModal && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[100] flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-4xl w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-5 text-slate-800 dark:text-slate-100 animate-scale-in max-h-[90vh] flex flex-col">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="p-3.5 bg-slate-50 dark:bg-slate-950/60 rounded-2xl border border-slate-200 dark:border-slate-800 flex items-center gap-3">
              ...
              <div className="p-3.5 bg-slate-50 dark:bg-slate-950/60 rounded-2xl border border-slate-200 dark:border-slate-800 flex items-center justify-between">
                ...
                <button
                  ...
                  className="p-2 rounded-xl bg-[#2eb82e] hover:bg-emerald-600 text-white transition shadow-sm cursor-pointer"
                >
              ...
              <div className="space-y-3 flex-1 overflow-y-auto pr-1">
                ...
                <div className="flex justify-between items-center gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl pl-8 pr-3 py-1.5 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-[#2eb82e]"
                    />
                  </div>
                  <button
                    type="button"
                ...
                <div className="border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-xs">
                  <table className="w-full text-left border-collapse text-xs">
                    <thead>
                      <tr className="bg-slate-100/80 dark:bg-slate-950/80 border-b border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 font-bold">
                    ...
                    <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                      {akademilerDetayli.filter(ak => 
                        ...
                        akademilerDetayli
                          ...
                          .map((ak) => (
                            <tr key={ak.id} className="hover:bg-slate-50 dark:hover:bg-slate-950/50 transition">
                              ...
                              <td className="p-3 font-semibold text-slate-700 dark:text-slate-300">
                                <span className="bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded text-[11px] font-mono text-slate-800 dark:text-slate-200 mr-1.5">
            ...
            {panelTab === 'create' && (
              <div className="space-y-4 flex-1 overflow-y-auto pr-1">
                ...
                <form onSubmit={handleKurulumSubmit} className="space-y-3 max-w-lg mx-auto bg-slate-50 dark:bg-slate-950/60 p-4 rounded-2xl border border-slate-200 dark:border-slate-800">
                  <div>
                    <label className="block text-[11px] font-semibold text-slate-700 dark:text-slate-300 mb-1">
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-semibold text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-[#2eb82e]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:border-[#2eb82e]"
                    />
                  </div>
                  ...
                  <div className="flex justify-end gap-2 pt-2 border-t border-slate-200 dark:border-slate-800">
                    <button
                      type="button"
                      onClick={() => setPanelTab('list')}
                      className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold rounded-xl transition cursor-pointer"
                    >
                      İptal / Listeye Dön
                    </button>
                    <button
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-[#2eb82e] to-emerald-600 hover:from-emerald-500 hover:to-emerald-600 text-white font-bold text-xs rounded-xl shadow-md transition flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                    >
