      ...
      <Router>
        {!currentUser ? (
          <Routes>
            ...
            <Route path="*" element={<Login onLoginSuccess={(user) => setCurrentUser(user)} />} />
          </Routes>
        ) : (
          <div className="min-h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans selection:bg-[#2eb82e] selection:text-white transition-colors duration-300">
