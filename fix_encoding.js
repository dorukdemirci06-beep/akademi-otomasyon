...
const originalDashboard = fs.readFileSync('frontend/src/pages/Dashboard.jsx', 'utf8');

// Generate Siniflar.jsx
...
const modalsStart = siniflar.indexOf('{/* ================= MODAL: Yeni Sınıf Ekle Sub-Modal');
...
// Fix max-w-2xl to max-w-5xl for the modal in Siniflar.jsx
siniflar = siniflar.replace(/max-w-2xl w-full max-h-\[85vh\]/, 'max-w-5xl w-full max-h-[85vh]');
...
console.log('Success properly encoded');
